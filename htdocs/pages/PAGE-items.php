...
<!-- (B1) HEADER -->
<h3 class="mb-3">LAGERLISTE</h3>

<!-- (B2) SEARCH BAR -->
<form class="d-flex align-items-stretch head border mb-3 p-2" onsubmit="return item.search()">
  <input type="text" id="item-search" placeholder="Artikelname oder SKU / Lieferant" class="form-control form-control-sm">
  ...
  <ul class="dropdown-menu dropdown-menu-dark">
    <li class="dropdown-item" onclick="item.addEdit()">
      <i class="text-secondary ico-sm icon-plus"></i> Hinzufügen
    </li>
