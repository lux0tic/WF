  ...
  <body class="bg-light">
    ...
    <div id="cb-body" class="d-flex">
      ...
      <nav id="cb-side" class="bg-dark text-white p-2"><ul class="navbar-nav">
        ...
        <li class="nav-item">
          <div class="my-2 fw-bold">Lager</div>
          <a class="nav-link ms-1" href="<?=HOST_BASE?>items">
            <i class="text-secondary ico-sm icon-price-tag"></i> Lagerliste
          </a>
          <a class="nav-link ms-1" href="<?=HOST_BASE?>move">
            <i class="text-secondary ico-sm icon-truck"></i> Bewegung
          </a>
          <a class="nav-link ms-1" href="<?=HOST_BASE?>check">
            <i class="text-secondary ico-sm icon-qrcode"></i> QR-Check
          </a>
          <hr>
        </li>
        <li class="nav-item">
          <div class="my-2 fw-bold">Lieferung</div>
          <a class="nav-link ms-1" href="<?=HOST_BASE?>cus">
            <i class="text-secondary ico-sm icon-address-book"></i> Kunden
          </a>
          <a class="nav-link ms-1" href="<?=HOST_BASE?>deliver">
            <i class="text-secondary ico-sm icon-file-text2"></i> Bestellungen
          </a>
          <hr>
        </li>
        <li class="nav-item">
          <div class="my-2 fw-bold">Einkauf</div>
          <a class="nav-link ms-1" href="<?=HOST_BASE?>sup">
            <i class="text-secondary ico-sm icon-address-book"></i> Lieferanten
          </a>
          ...
          <hr>
            ...
            <i class="text-secondary ico-sm icon-meter"></i> Bestandskontrolle
          </a>
          <a class="nav-link ms-1" href="<?=HOST_BASE?>reports">
            <i class="text-secondary ico-sm icon-pie-chart"></i> Dokumente
          </a>
          <hr>
            <div class="my-2 fw-bold"> V1.0.0 (26062025)</div>
        </li>
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end">
                ...
                <li class="dropdown-item text-warning" onclick="cb.bye()">
                  <i class="ico-sm icon-exit"></i> Abmelden
                </li>
              </ul>
            </div>
          </div>
